...
//constructor
    ...
    public  boolean isMammals(){return this.mammals;}
    public  void setMammals(boolean mammals){this.mammals=mammals;}
    public  boolean isCarnivoros(){return this.carnivoros;}
    public  void setCarnivoros(boolean carnivoros){this.carnivoros=carnivoros;}
